...
urlpatterns = [
        ...
        path('ingresarCliente', include('app.urls')),
        path('listarProductosFull', include('app.urls')),
        path('listarClientesFull', include('app.urls')),
        path('editarProducto/<int:producto_id>', include('app.urls')),
        path('editarCliente/<int:cliente_id>', include('app.urls')),
        path('borrarProducto/<int:producto_id>', include('app.urls')),
        path('borrarCliente/<int:cliente_id>', include('app.urls')),
        path('listarProductos', include('app.urls')),
        path('listarClientes', include('app.urls')),
